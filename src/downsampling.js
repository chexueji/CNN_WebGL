...
class Downsampling extends Operator {
    ...
    allocMemory(inputs) {
      console.assert(false,'Downsampling run allocMemory() of base class');
    }
...
class Downsampling_Linear extends Downsampling {
    constructor(gl, packed) {
        super(gl, packed);
    }
...
class Downsampling_Nearest extends Downsampling {
    constructor(gl, packed) {
        super(gl, packed);
    }
...
export {Downsampling_Nearest, Downsampling_Linear}